...
class Demo4_NonBlockingSlowPrintTextService extends AbstractTestNGSpringContextTests {
	@Autowired
	...
	private Logger logger = Logger.getLogger(Demo4_NonBlockingSlowPrintTextService)
